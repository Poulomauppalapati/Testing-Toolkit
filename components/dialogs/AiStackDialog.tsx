...
const LAYERS: StackLayer[] = [
  {
    ...
    icon: Brain,
    ttUsing: "azure.gpt-4o / azure.gpt-4-turbo",
    ttDetail: "Primary reasoning model for TC generation, RLM retrieval, and contextual analysis — served via the GenAI LiteLLM proxy.",
    statusKey: "llm",
    tools: [
      { name: "azure.gpt-4o", active: true },
      { name: "azure.gpt-4-turbo", active: true },
      { name: "Claude Sonnet 4", active: false },
      { name: "Gemini 1.5 Pro" },
      { name: "Qwen 2.5" },
      { name: "LLAMA 4" },
      { name: "deepseek-r1" },
